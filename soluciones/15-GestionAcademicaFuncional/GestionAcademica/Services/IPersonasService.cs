...
public interface IPersonasService {
    ...
    /// </summary>
    /// <returns>Una lista enlazada con todas las personas activas.</returns>
    ILista<Persona> GetAll();
    ...
    /// <returns>Una lista enlazada con las personas que cumplen los criterios.</returns
    ILista<Persona> GetAllOrderBy(TipoOrdenamiento orden = TipoOrdenamiento.Dni, Predicate<Persona>? filtro = null);
    ...
    /// <returns>Una lista enlazada con los estudiantes ordenados según el criterio.</returns>
    ...
    /// </summary>
    /// <param name="ordenamiento">Criterio de ordenamiento para el listado.</param>
    /// <returns>Una lista enlazada con los docentes ordenados según el criterio.</returns>
